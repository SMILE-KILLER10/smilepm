...
DEFAULT_START_TEXT = (
    "<b>ഞാൻ @SMILE_KILLER_010 ന്റെ ബോട്ട് ആണ് നിങ്ങൾക്ക് എന്തെങ്കിലും സംശയമുണ്ടെങ്കിൽ അത് ഇവിടെ പറയാം എന്റെ MASTER ഓൺലൈനിൽ വരുമ്പോൾ നിങ്ങൾക്ക് റിപ്ലൈ തരുന്നതാണ്"
    " ഇവിടെ ആരും സിനിമ ചോദിക്കരുത് പ്ലീസ്😖</b>"
)
...
ONLINE_CHECK_START_TEXT = get_config(
    ...
    (
        ...
        "ℹ️ Subscribe @filmcornermm if you 😍 using this bot❗️❣️"
    )
)
# message to indicate,
