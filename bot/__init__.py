...
DEFAULT_START_TEXT = (
    "ഞാൻ @SMILE_KILLER_10 ന്റെ ബോട്ട് ആണ് നിങ്ങൾക്ക് എന്തെങ്കിലും സംശയമുണ്ടെങ്കിൽ അത് ഇവിടെ പറയാം എന്റെ MASTER ഓൺലൈനിൽ വരുമ്പോൾ നിങ്ങൾക്ക് റിപ്ലൈ തരുന്നതാണ്"
